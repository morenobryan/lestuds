defmodule StudyManager.StudyPlans do
  @moduledoc """
  The StudyPlans context.
  """
  ...
  """
  def list_plans do
    Plan |> Repo.all |> Repo.preload(:subjects)
  end
  ...
  """
  def get_plan!(id), do: Plan |> Repo.get!(id) |> Repo.preload(:subjects)
